...
public class BatchConfiguration {
    ...
    @Bean
    public Job jobTraiterLigneFichier() {
        log.info("debut du job jobTraiterLigneFichier...");
				
		return jobs
			.get("chunksJob")
			.start(stepLireLigneFichier())
    ...
    // ------------- TASKLETS -----------------------
    @Bean
    public LireLigneFichierTasklet lireLigneFichierTasklet()
    {
        return new LireLigneFichierTasklet();
    }
